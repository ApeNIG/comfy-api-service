...
This script manually creates the initial migration for our three tables:
- users
- subscriptions
- jobs
"""
...
revision = f"{timestamp}_initial"

migration_content = f'''"""Initial migration: users, subscriptions, jobs tables
...
migration_file = f"alembic/versions/{revision}_initial.py"
with open(migration_file, "w") as f:
    f.write(migration_content)

print(f"Created migration: {migration_file}")
print(f"Revision ID: {revision}")
